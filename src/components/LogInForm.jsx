...
export default function LogInForm({onClose, onSwitchToRegister}){
    ...
    return(
        <form onSubmit={handleLogin} className="pt-20 px-10 flex flex-col w-1/3 gap-4 relative backdrop-blur-lg border border-white/50 rounded-2xl">
            ...
            <div className="flex flex-col gap-6 mb-8">
                ...
                <div className="flex gap-2">
                    ...
                    <div className="capitalize text-green-700 transition-all duration-200 hover:animate-bounce cursor-pointer" onClick={onSwitchToRegister}>register Here</div>
                </div>
            </div>
        </form>
    )
