                ...
                <ul className="flex gap-5 items-center">
                    {
                        links.map((link, index)=> (
                            <li key={index} className="text-xl font-bold text-white cursor-pointer hover:text-amber-400/95 hover:gold-text-shadow-sm hover:scale-110 hover:p-4">{link}</li>
                        ))
                    }
                </ul>
                <div className="flex gap-5 items-center">
